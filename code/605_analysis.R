...
data4[which(data4$VCF0050b==9),which(names(data4)%in%"VCF0050b")]=NA
data4[which(data4$VCF0428>97),which(names(data4)%in%"VCF0428")]=NA
data4[which(data4$VCF0429>97),which(names(data4)%in%"VCF0429")]=NA
data4[which(data4$VCF0104==0),which(names(data4)%in%"VCF0104")]=NA
